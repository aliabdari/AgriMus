...
if __name__ == '__main__':
    ...
    if base_features == base_features_list[0]:
        frame_video_representation = [('Mean'), ('Median'), ('Max')]

    for fvr in frame_video_representation:
        # Load Queries
        ...
        # Load Museums
        path_museums = f'../feature_generation/{base_features}/museums_{fvr}/'
