...
for v in tqdm(list_videos):
    ...
    command1 = ["7z", "e", path_zip_file, f"howto100m_s3d_features/{v}.mp4.npy", f"-o{path_s3d_features}"]
    command2 = ["7z", "e", path_zip_file, f"howto100m_s3d_features/{v}.webm.npy", f"-o{path_s3d_features}"]
