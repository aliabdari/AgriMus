...
txt = "Hey guys, hope you're all having a wonderful day. " \
...
# Summarize text to extract main points
summary = summarizer(clean_transcription(txt), max_length=50, min_length=20, do_sample=False)
