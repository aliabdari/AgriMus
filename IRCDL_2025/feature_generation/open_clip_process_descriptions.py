...
path_descriptions = '/data01/aabdari/projects/Agr_dataset_Collection/text_proc/textual_data/descriptions'
list_txt_files = os.listdir(path_descriptions)

path_sentence_level_features = '/data01/aabdari/projects/Agr_dataset_Collection/text_proc/textual_data/open_clip/descriptions/sentences/'
path_token_level_features = '/data01/aabdari/projects/Agr_dataset_Collection/text_proc/textual_data/open_clip/descriptions/tokens/'
path_token_strings = '/data01/aabdari/projects/Agr_dataset_Collection/text_proc/textual_data/open_clip/descriptions/tokens_strings/'
